...
const (
	...
	BuildKind_BUILD_KIND_JOB_CREATE_WITH_CONTAINER_IMAGE BuildKind = 7 // tsuru job create/update ... -i registry.example.com/tsuru/my-job:latest
	BuildKind_BUILD_KIND_JOB_DEPLOY_WITH_CONTAINER_FILE  BuildKind = 8 // tsuru job create/update ... --dockerfile Dockerfile --dockerfile-context ./
)
...
var file_pkg_build_grpc_build_v1_build_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2a, 0xfc, 0x03, 0x0a, 0x09, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x4b,
